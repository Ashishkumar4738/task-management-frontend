...
const ViewCard = (props) => {
  ...
  return (
    <>
      ...
      <p className='absolute right-10  border-2 border-black px-2 rounded-full top-6 md:top-2 shadow-lg shadow-white/20 font-bold cursor-pointer  ' onClick={close} >X</p>
