  ...
  return (
    <>
      <div className="absolute top-5 right-2 md:right-10 z-50 flex justify-end">
        {props.alert && (
          <div className={`${props.alert.type === 'success' ? "bg-green-100 text-green-500 " : props.alert.type === 'warning' ? "bg-yellow-100 text-yellow-500 " : "bg-red-100 text-red-500"} px-4 py-2 rounded-[20px]`}>
